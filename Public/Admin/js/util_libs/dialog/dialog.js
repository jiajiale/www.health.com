...
(function ($, window, undefined) {
    ...
    //解决jQuery1.9.0以上对$.browser检测不支持Begin
    //jQuery.extend({
    //    browser: function()
    //    {
    //        var
    ...
    //    };
    //}
    //解决jQuery1.9.0以上对$.browser检测不支持End
				...
				<div class="core_pop">\
					<% if(type === "iframe" || type === "html") {%>\
						<div class="pop_top J_drag_handle" style="display:none;overflow:hidden;">\
							<a role="button" href="#" class="pop_close J_close" title="关闭弹出窗口"></a>\
							<strong><%=title%></strong>\
						</div>\
					<% } %>\
					<% if(type === "iframe") { %>\
            ...
            try {
                $(iframe).load(function () {
                    ...
                    try {
                        ...
                        elem.find('.J_drag_handle').css(width, 435);
                        loading.hide();
                        pop_top.show();
                        iframe.scrolling = 'yes';
                        $(iframe).show();
                    ...
                    iframe_content.resize(function () {
                        ...
                        elem.find('.J_dialog_iframe').height(height);
                    });
