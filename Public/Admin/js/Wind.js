...
(function (win) {
    ...
    //定义常用JS组件别名，使用别名加载
        alias = {
            ...
            tabs: 'util_libs/tabs/jquery.idTabs',
            webUploader: 'util_libs/webuploader/webuploader',
            uploadify: 'util_libs/uploadify/jquery.uploadify',
            autoComplete: 'util_libs/autoComplete/jquery.autocomplete'
        },
        alias_css = {
            layer: 'util_libs/layer/skin/layer',
            datePicker: 'util_libs/datePicker/style',
            webUploader: 'util_libs/webuploader/webuploader',
            uploadify: 'util_libs/uploadify/uploadify',
            autoComplete: 'util_libs/autoComplete/jquery.autocomplete'
            //chosen: 'ui_libs/chosen/chosen'
        };
